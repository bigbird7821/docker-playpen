...
puppet_config_set() {
  "${PUPPET_BIN_DIR}/puppet" config set server primary-2019.platform9.puppet.net --section main
...
supported_platform() {
  ...
  t_supported_platform_regex='(el-(5|6)-(i386|x86_64))|(el-7-ppc64le)|(el-(7|8)-(x86_64|aarch64))|(redhatfips-7-x86_64)|(debian-(8|9)-(i386|amd64))|(debian-10-amd64)|(ubuntu-(14\.04|16\.04)-(i386|amd64|ppc64el))|(ubuntu-16\.04-ppc64el)|(ubuntu-(18\.04|20\.04)-amd64)|(sles-(11|12|15)-(x86_64))|(sles-11-i386)|(sles-12-ppc64le)|(fedora-(30|31)-(x86_64))|(solaris-(10|11)-(i386|sparc))|(aix-7\.1-power)|(osx-10\.(14|15)-x86_64)'
...
run_agent_install_from_url() {
    ...
    The required agent packages should be retrieved when puppet runs on the master, after which you can run the install.bash script again."
            ...
            fail "This method of agent installation is not supported for ${PLATFORM_TAG} in Puppet Enterprise v2019.8.5"
        fi
    fi
    ...
    # Test for Debian releases
        ...
        if grep -qi 'amazon linux' /etc/system-release; then
          ...
          sanitize_platform_release
            ...
            fail "$(cat /etc/system-release) is not a supported platform for Puppet Enterprise v2019.8.5
        ...
        fail "$(uname -s) is not a supported platform for Puppet Enterprise v2019.8.5
            Please visit http://links.puppetlabs.com/puppet_enterprise_${PE_LINK_VER}_platform_support to request support for this platform."
    fi
fi
...
bulk_pluginsync "https://primary-2019.platform9.puppet.net:8140/packages/bulk_pluginsync.tar.gz"

run_agent_install_from_url "https://primary-2019.platform9.puppet.net:8140/packages/2019.8.5/${PLATFORM_TAG}.bash" "$@"
